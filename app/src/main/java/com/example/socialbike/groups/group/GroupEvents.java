...
public class GroupEvents extends Fragment implements RecyclerViewAdapter.ItemClickListener, Updater.IUpdate {

    private static GroupEvents groupFragment;
    ...
    public static GroupEvents getInstance() {
        if (groupFragment == null) {
            groupFragment = new GroupEvents();
        }
